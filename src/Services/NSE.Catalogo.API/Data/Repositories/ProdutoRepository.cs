...
namespace NSE.Catalogo.API.Data.Repositories
{
    public class ProdutoRepository : IProdutoRepository
    {
        ...
        public async Task<IEnumerable<Produto>> ObterProdutosPorIds(string ids)
        {
            if (string.IsNullOrEmpty(ids)) return new List<Produto>();
        ...
        public async Task<PagedResult<Produto>> ObterTodos(int pageSize, int pageIndex, string query = null)
        {
            ...
            var quantidade = multi.Read<int>().FirstOrDefault(); ;
